...
fun HomeScreen(
    ...
    val recentSearchQueries = viewModel.homeState.value.recentSearchQueries
    ...
    HomeContent(
        ...
        onRecentQuerySearchClicked = { viewModel.onEvent(HomeEvent.OnRecentQuerySearchClicked(it)) }
    )
}